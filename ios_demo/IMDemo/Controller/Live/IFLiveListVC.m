...
- (void)refreshList
{
    ...
    {
        [m_interfaceUrls demoQueryList:LIST_TYPE_LIVE_ALL];
    }
    else
    {
        __weak typeof(self) weakSelf = self;
        [[XHClient sharedClient].liveManager queryLiveList:@"" type:LIST_TYPE_LIVE_ALL completion:^(NSString *listInfo, NSError *error) {
            NSData *jsonData = nil;
